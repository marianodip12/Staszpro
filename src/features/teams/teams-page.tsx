...
export const TeamsPage = () => {
  ...
  const handleDeleteTeam = (team: HandballTeam) => {
    ...
    if (window.confirm(msg)) {
      removeTeam(team.id);
      // Soft-delete server-side: marca deleted_at en Supabase. El team queda
      // guardado en BD pero no se vuelve a mostrar al usuario y no se re-sube.
      void softDeleteTeamRemote(team.id);
    }
  };
