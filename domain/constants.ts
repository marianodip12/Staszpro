...
export const NAV_ITEMS: NavItem[] = [
  { key: 'matches',   path: '/app',           label: 'Partidos'  },
  { key: 'teams',     path: '/app/teams',     label: 'Equipos'   },
  { key: 'live',      path: '/app/live',      label: 'En Vivo'   },
  { key: 'stats',     path: '/app/stats',     label: 'Stats'     },
  { key: 'evolution', path: '/app/evolution', label: 'Evolución' },
];
